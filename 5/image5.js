...
axios.get('https://http.cat/500', {
    ...
    .then(function (response) {
        ...
        fs.writeFileSync("cat500.jpg", response.data)
        console.log(response);
    })
axios.get('https://http.cat/501', {
        responseType: 'arraybuffer'
    })
    .then(function (response) {
